...
public class SimpleSectionRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SimpleSectionRecyclerAdapter(Context context, int sectionResourceId, int textResourceId,
    ...
    public long getItemId(int position) {
        return isSectionHeaderPosition(position) ?
                Integer.MAX_VALUE - mSections.indexOfKey(position) : mBaseAdapter.getItemId(sectionedPositionToPosition(position));
    }
    ...
    /**
     * Object representing a section in the RecyclerView's adapter.
     */
    public final static class Section {
        int firstPosition; //position in the adapter
